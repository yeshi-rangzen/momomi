...
namespace MomomiAPI.Migrations
{
    ...
    [Migration("20250731041846_AddedNeighbourhoodField")]
    partial class AddedNeighbourhoodField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MomomiAPI.Models.Entities.UserLike", b =>
                {
                    ...
                    b.HasIndex("LikerUserId", "CreatedAt")
                        .IsDescending(false, true)
                    ...
                    b.HasIndex("LikedUserId", "IsLike", "IsMatch")
                        .HasDatabaseName("idx_user_likes_received")
                        .HasFilter("is_like = true");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("LikedUserId", "IsLike", "IsMatch"), new[] { "LikerUserId", "CreatedAt", "LikeType" });

                    b.HasIndex("LikedUserId", "IsMatch", "IsLike")
                        .HasDatabaseName("index_user_likes_liked_matches")
                        .HasFilter("is_match = true AND is_like = true");

                    b.HasIndex("LikerUserId", "LikedUserId", "IsMatch", "IsLike")
