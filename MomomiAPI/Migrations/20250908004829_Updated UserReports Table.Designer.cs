...
namespace MomomiAPI.Migrations
{
    ...
    [Migration("20250908004829_Updated UserReports Table")]
    partial class UpdatedUserReportsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MomomiAPI.Models.Entities.UserReport", b =>
                {
                    ...
                    b.Property<string>("ReportedEmail")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("reported_email");

                    b.Property<int?>("ReportedGender")
                        .HasColumnType("integer")
                        .HasColumnName("reported_gender");
